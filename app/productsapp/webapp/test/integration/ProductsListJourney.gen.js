...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check filter bar", function (Given, When, Then) {
            Then.onTheProductsListGenerated.onFilterBar().iCheckFilterField({ property: "status" });
            Then.onTheProductsListGenerated.onFilterBar().iCheckFilterField({ property: "category_ID" });
        });
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheProductsListGenerated.onTable(defaultTableId).iCheckColumns(undefined, {"code":{"header":"Code"},"name":{"header":"Name"},"category/name":{"header":"Category"},"price":{"header":"Price"},"discount":{"header":"Discount %"},"stock":{"header":"Stock"},"status":{"header":"Status"}});
        });
